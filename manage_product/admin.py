...
from .models import ProductId, Email, Town, Worker, FotoOrder, Articles, Template
...
class ProductIdAdmin(admin.ModelAdmin):
    list_display = ('email', 'template_name', 'date_opening', 'payment_id',
                    'send_link_for_pay', 'paid', 'created',
                    'completed', 'date_payment', 'product_link')
...
class FotoOrderAdmin(admin.ModelAdmin):
    list_display = ('client_email', 'town', 'ed_institution',
                    'the_class', 'status', 'photo_available')


class TemplateAdmin(admin.ModelAdmin):
    list_display = ('template_id', 'template_name', 'note')
